        ...
        //We have another attribute to read
           ...
           if (strcmp(key, "width") == 0){
            ...
            //Get the specular color - applies to all but cameras and lights
              ...
              if(objects[i]->kind == 0 || objects[i]->kind == 3 ) {
                fprintf(stderr, "Error, type/key missmatch, line number %d \n", line);
                exit(1);
              }
              s = 1;
              ...
              //color for spheres
              if(objects[i]->kind == 1) {
                objects[i]->sphere.specular[0] = val[0];
                objects[i]->sphere.specular[1] = val[1];
                objects[i]->sphere.specular[2] = val[2];

              }
              //Color for planes
              else {
                objects[i]->plane.specular[0] = val[0];
                objects[i]->plane.specular[1] = val[1];
                objects[i]->plane.specular[2] = val[2];
              }
            }
              ...
              if (val > 1.0) val = 1.0;
              if (val < 0.0) val = 0.0;
              //set reflectivity for spheres
              if(objects[i]->kind==1) {
                objects[i]->sphere.reflect = val;
              }
              //set reflectivity for planes
              else {
                objects[i]->plane.reflect = val;
              }
            }
              ...
              if (val > 1.0) val = 1.0;
              if (val < 0.0) val = 0.0;
              //set refractivity for spheres
              if(objects[i]->kind==1) {
                objects[i]->sphere.refract = val;
              }
              //set refractivity for planes
              else {
                objects[i]->plane.refract = val;
              }
            }
              ...
              //set ior for spheres
              if(objects[i]->kind==1) {
                objects[i]->sphere.ior = val;
              }
              //set ior for planes
              else {
                objects[i]->plane.ior = val;
              }
            }

            //Get the diffuse color - applies to all but cameras and lights
              ...
              //color for spheres
              if(objects[i]->kind == 1) {
                objects[i]->sphere.diffuse[0] = val[0];
                objects[i]->sphere.diffuse[1] = val[1];
                objects[i]->sphere.diffuse[2] = val[2];

              }
              //Color for planes
              else {
                objects[i]->plane.diffuse[0] = val[0];
                objects[i]->plane.diffuse[1] = val[1];
                objects[i]->plane.diffuse[2] = val[2];
              }
            }
